...
class WorldTraj(object):
    ...
    def compute_splines(self,points, times):
        ...
        M1 = np.vstack((loc_cons_t, loc_cons_tp, vel_cons_t,acc_cons_t))
        
        M_mat.append(self.constraints_row([M1], [0], segs))
        b_mat.append(np.array([points[0], points[1], 0, 0]))
        ...
        # COntinuit constraint for last spline
        ...
        acc_cons_tp = self.get_acc_matrix(times[-1],order)
